...
def show_loading_screen(screen):
    ...
    # Dessiner la roue de chargement
    loading_wheel = pygame.Surface((50, 50))
    loading_wheel.set_colorkey((0, 0, 0))
    pygame.draw.circle(loading_wheel, (0, 0, 0), (25, 25), 20, 2)

    # Calculer l'angle de rotation
    angle = pygame.time.get_ticks() / 10 % 360
    rotated_wheel = pygame.transform.rotate(loading_wheel, angle)
    screen.blit(rotated_wheel, (WORLD_SIZE_X * CELL_SIZE // 2 - 25, WORLD_SIZE_Y * CELL_SIZE // 2 - 25))
